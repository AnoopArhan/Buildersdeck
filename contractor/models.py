...
class Contractor_TB(models.Model):
    ...
    contra_id=models.CharField(max_length=20,default=0)
    
    def __str__(self):
        return self.Company
    
class Cwork_TB(models.Model):
    ...
    dislikeflag=models.BooleanField(default="False")
